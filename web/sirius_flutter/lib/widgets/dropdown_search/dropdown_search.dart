...
import 'package:sirius_flutter/widgets/dropdown_search/popupMenu.dart';
import 'package:sirius_flutter/widgets/dropdown_search/selectDialog.dart';
...
class DropdownSearch<T> extends StatefulWidget {
  ...
  DropdownSearchState<T> dropdownSearchState;
  ...
  @override
  DropdownSearchState<T> createState() =>
      dropdownSearchState = DropdownSearchState<T>();
}
      ...
      children: <Widget>[
        Expanded(
          child: widget.dropdownBuilder != null
              ...
              : Text(textName, style: Theme.of(context).textTheme.subtitle1),
        ),
